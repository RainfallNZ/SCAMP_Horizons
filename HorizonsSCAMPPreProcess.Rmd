...
#Scenario <- "HorticultureExpansion"
```
...
#LeachRateLUTFile                  <- file.path(DataDirectory,"LandUseToLossRatesV1.csv")
...
if (Scenario == "HorticultureExpansion"){
  SubZoneLanduseShapeFile         <- file.path(GISDataDirectory,"ZoneLanduse","ZoneLanduseV2_with_hort_expansion_scenario")
SubZoneLanduseAggShapeFile        <- file.path(GISDataDirectory,"ZoneLanduse","ZoneLanduseAggV2_with_hort_expansion_scenario")
LeachRateRasterFile               <- file.path(GISDataDirectory,"LeachRateRasterHortExpansion 250x250.tif")
ZoneLanduseRasterFile             <- file.path(GISDataDirectory,"ZoneLanduseRasterHortExpansion 250 x 250.tif")
ZoneLanduseCode_To_ClassLUTFile   <- file.path(DataDirectory,"ZoneLanduseCode_To_ClassLUTHortExpansion.csv")
}
...
saveWorkbook(Out, file.path(DataDirectory,"SCAMP-Inputs_HorizonsV7Test.xlsx"), overwrite = T)
```
